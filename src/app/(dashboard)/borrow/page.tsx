...
export default function BorrowPage() {
  ...
  const filtered = listings.filter(l =>
    l.title.toLowerCase().includes(search.toLowerCase()) && l.is_available
        ...
        <>
          ...
          {loading ? (
            ...
            <div style={{ textAlign: 'center', padding: '80px 0' }}>
              ...
              <p style={{ fontSize: '14px', color: 'var(--on-surface-variant)', marginTop: '8px' }}>Items listed in the marketplace can be borrowed. Be the first to list something!</p>
