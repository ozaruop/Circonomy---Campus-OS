...
import { ShoppingBag, HandshakeIcon, Briefcase, TrendingUp, ArrowRight, Zap } from 'lucide-react'
      ...
      <motion.section initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.2 }} style={{ marginBottom: '40px' }}>
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '20px' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
            ...
            <h2 style={{ fontSize: '20px', fontWeight: 700, fontFamily: 'var(--font-manrope)', color: 'var(--on-surface)' }}>Trending Now</h2>
          </div>
          <Link href="/marketplace" style={{ textDecoration: 'none' }}>
            <span style={{ fontSize: '13px', fontWeight: 600, color: 'var(--primary)', display: 'flex', alignItems: 'center', gap: '4px' }}>Explore all <ArrowRight size={14} /></span>
          </Link>
        </div>
        ...
        <motion.section initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.3 }} style={{ marginBottom: '40px' }}>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '20px' }}>
            ...
            <Link href="/gigs" style={{ textDecoration: 'none' }}>
              <span style={{ fontSize: '13px', fontWeight: 600, color: 'var(--primary)', display: 'flex', alignItems: 'center', gap: '4px' }}>See all <ArrowRight size={14} /></span>
            </Link>
          </div>
        ...
        <div className="signature-gradient" style={{ borderRadius: '24px', padding: '32px 36px', color: 'white', display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '16px' }}>
          <div>
            ...
            <p style={{ fontSize: '20px', fontWeight: 700, fontFamily: 'var(--font-manrope)', lineHeight: 1.4 }}>
              ...
              <span style={{ opacity: 0.85, fontSize: '16px' }}>{trustScore >= 75 ? "You're a top-rated member!" : "Complete more trades to grow your score."}</span>
            </p>
          </div>
