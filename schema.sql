-- ============================================================
-- Circonomy Campus OS — Fixed Schema (Postgres 15 compatible)
-- ============================================================
...
create table if not exists gigs (
  ...
  category text not null,
  price numeric(10,2) not null,
  price_type text default 'PROJECT' check (price_type in ('HOURLY','PROJECT','FIXED')),
...
-- ============================================================
-- REALTIME — Run these two lines separately if needed
-- ============================================================
